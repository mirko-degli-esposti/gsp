...
La risposta breve: la zonizzazione trattiene fra il 2% e il 15% del segnale
compositivo disponibile a livello di sezione. **Fra l'85% e il 98% sta sotto
il quartiere.** È la ragione per cui l'anello 3 esiste.
...
Cinque configurazioni. B = 1.000 repliche per il nullo di zona, 250 per il
soffitto di sezione. Seed 20260731.
...
**(1) La perdita è dell'85–98%.** La quota trattenuta va dal 2,4% al 15,2%.
Quasi tutta la struttura spaziale della composizione sta sotto il
quartiere. È la giustificazione quantitativa dell'anello 3.

**(2) Il segnale è statisticamente schiacciante e sostanzialmente
minuscolo.** Le z vanno da 31 a 58; le frazioni di H(K) rimosse dalla zona
dallo 0,25% all'1,50%. Su 28.000–59.000 individui la significatività è
...
**(4) La granularità è necessaria ma non sufficiente.** Parma con 13 zone
trattiene l'8,0%, Bologna con 18 il 5,5%. Il numero di zone fissa il tetto;
quanto se ne realizzi dipende dall'allineamento della partizione alla
geografia dell'insediamento. Confermato da entrambe le metriche.
...
6 è garantito a priori; l'unica quantità empirica è di quanto.
...
|---|---|---|---|
| 0 | nessuna: `P(paese \| area, sesso)` comunale | riserva (`--no-tier`) | — |
...
Per la scelta dei comuni da aggiungere: il criterio "più zone è meglio" va
sostituito. **Il numero di zone fissa il tetto, l'allineamento della
partizione determina la resa**, e va misurato invece che assunto. Ma la
variabile più critica è un'altra: **l'esistenza di una fonte open data
comunale sulla cittadinanza**, che determina il tier e quindi se il paese
sia condizionato alla geografia o no.

Per Modena, che ha il segnale spaziale più alto e la partizione peggiore, la
verifica del catalogo open data ha priorità sulla ricerca di una partizione
alternativa.

La stessa misura andrà ripetuta su Ravenna (10 aree) e Forlì (21 quartieri)
quando le rispettive popolazioni saranno generate.
...
ramo comunale del pipeline.
    ...
    python perm_composizione.py 037006 --level COM_ASC2 -B 1000 \
        --out /tmp/perm2_bo18.csv
