...
ORD=(report_frontmatter_v0.1.md #animarium_report_skeleton_v0.1.md
     report_part1_v1.md
     report_part2_v0.1.md
     report_part2_s4_v0.1.md
     report_part3_s1-2_v0.1.md
     report_part3_s3_v0.1.md
     report_part3_s456_v0.1.md
     report_part4_v0.1.md
...
if pandoc "$T"/*.md -o "$OUT" --pdf-engine=xelatex \
  ...
  pandoc "$T"/*.md --standalone --toc --toc-depth=2 \
